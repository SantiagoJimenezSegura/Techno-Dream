...
StartupEvents.registry('item', technodream => {
    ...
    technodream.create('dream_coin_quarter')
    .displayName('Cuarto de Moneda Onírica')
    .tooltip('¡Que brillante!')
    .tooltip('Gasta esta moneda, no seas tacaño')
    .maxStackSize('64')
    technodream.create('dream_coin_medium')
    .displayName('Media Moneda Onírica')
    .tooltip('¡Que brillante!')
    .tooltip('Gasta esta moneda, no seas tacaño')
    .maxStackSize('64')
    technodream.create('dream_coin_big')
    .displayName('Gran Moneda Onírica')
    .tooltip('¡Que brillante!')
    .tooltip('Gasta esta moneda, no seas tacaño')
    .maxStackSize('64')
    
    technodream.create('vaccum_tube_component')
    .displayName('Componente de Tubo de Vacío')
    .maxStackSize('64')

    technodream.create('humidity_filter')
    .displayName('Filtro de Humedad')
    .maxStackSize('64')
    technodream.create('humidity_filter_used')
    .displayName('Filtro de Humedad Usado')
    .maxStackSize('64')
})
...
StartupEvents.registry('block', technodream => {
    ...
    technodream.create('primitive_humidity_casing') 
        .displayName('Carcasa de Filtro de Humedad')
        .textureAll('kubejs:block/primitive_humidity_casing')
        .soundType('metal')
})